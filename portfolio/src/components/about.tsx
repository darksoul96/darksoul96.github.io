...
export default function About() {
    return (
        <section className="about">
            ...
            <br />
            <p>
            I am an advanced software engineering student with a strong foundation in programming that began during my high school years. <br />
            <br />
Transitioning to college, I pursued further education in Informatics Engineering (Computer Science), where I have continued to
expand my engineering expertise. <br /><br />
Currently in my final year of studies, I have honed my programming skills and gained practical
experience in various engineering projects. <br /><br />
